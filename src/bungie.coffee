...
#
# Commands:
#   db armory <gamertag> - Returns that players Grimoire Score.
#   db played <gamertag> - Returns that players Last played character and lightlevel
#   db inventory <gamertag> - Returns that players Last played character's equipped inventory
#   db vendor xur - Returns Xur's Inventory or a warning when he isn't available
#
